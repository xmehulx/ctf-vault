...
```
We see that it has http, so I added it to my `etc/hosts` file and I would've ran `ffuf` in the hopes of finding some subdirectories or folders while I manually browse the webpage, but since the room said "Bruteforcing is out of scope" I skipped on that.
...
![Image](/writeups/assets/images/articles/mbilling.png){:.rounded}
...
![](/writeups/assets/images/articles/mbilling-version.png){:.rounded}
